...
const FeaturedCard = memo(
  ({
    ...
    <FadeIn delay={delay}>
      <div className="gradient-border rounded-xl overflow-hidden h-full flex flex-col transition-all duration-300 hover:shadow-[0_0_32px_hsl(225_75%_62%/0.15)] hover:scale-[1.015]">
        ...
        <div className="p-5 sm:p-6 flex flex-col flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="inline-flex items-center gap-1 ml-auto text-[10px] px-2 py-0.5 rounded-full bg-primary/15 text-primary font-medium">
              <Star className="w-3 h-3" /> Featured
            </span>
          </div>
          <p className="text-xs text-muted-foreground/70 mb-3 leading-relaxed">{project.tagline}</p>
          ...
          <div className="flex gap-2">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-md glass text-xs font-medium text-foreground hover:border-primary/40 transition-all"
            >
              <Github className="w-3.5 h-3.5" /> GitHub
            </a>
            <button
              onClick={() => onDetails(project.detail)}
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-md bg-primary/10 text-primary text-xs font-medium hover:bg-primary/20 transition-all"
            >
